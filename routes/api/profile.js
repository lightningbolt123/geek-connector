...
router.post('/', [
    ...
    if (!errors.isEmpty()) {
        // Return an errors array if errors are found in the request body
        return res.status(400).json({ errors: errors.array() });
    }

    // Destructure all the parameters from the request body
    const { 
            status,
            skills,
            company,
...
// @desc    get github all repos of user
// @access  Public
